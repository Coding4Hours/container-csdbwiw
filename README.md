...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-csdbwiw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-csdbwiw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Coding4Hours/container-csdbwiw.git
cd container-csdbwiw
```
...
```
docker attach container-csdbwiw
```
